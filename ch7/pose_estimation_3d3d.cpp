...
#include<Eigen/Core>
#include<Eigen/Dense>   // 稠密矩阵，即非0元素比较多的矩阵
 ...
 * @param keypoints_1  keypoints of image1
 * @param keypoints_2  keypoints of image2
...
/**
 * estimate pose by 3d feature points
 * @param pts1 keypoints of image1
 * @param pts2 keypoints of image2
...
/**
 * bundle adjustment calculate
 * @param pts1 keypoints_1 coor
 * @param pts2 keypoints_2 coor
 * @param R    rotation matrix
 * @param t    translation vector
 */
...
int main(int argc, char **argv)
{
    ...
    //--建立3D点
    Mat depth1 = imread(argv[3], CV_LOAD_IMAGE_UNCHANGED);  // 深度图，16位无符号数，单通道
    ...
    std::cout <<"calling bandle adjustment" << std::endl;
