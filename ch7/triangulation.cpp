 ...
 * @param keypoints_1 keypoints of image 1
 * @param keypoints_2 keypoints of image 2
...
/**
 * triangulation, access points' depth infomation
 * @param keypoints_1 keypoints of image1
 * @param keypoints_2 keypoints of image2
 * @param matches     matches between two images
 * @param R           rotation matrix
 * @param t           translation vector
 * @param points      3D points coor
 */
void triangulation(
    const vector<KeyPoint> &keypoints_1,
    const vector<KeyPoint> &keypoints_2,
